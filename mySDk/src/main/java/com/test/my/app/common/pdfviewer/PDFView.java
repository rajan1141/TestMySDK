package com.test.my.app.common.pdfviewer;
...
import com.test.my.app.common.pdfviewer.exception.PageRenderingException;
import com.test.my.app.common.pdfviewer.link.DefaultLinkHandler;
import com.test.my.app.common.pdfviewer.link.LinkHandler;
import com.test.my.app.common.pdfviewer.listener.Callbacks;
import com.test.my.app.common.pdfviewer.listener.OnDrawListener;
import com.test.my.app.common.pdfviewer.listener.OnErrorListener;
import com.test.my.app.common.pdfviewer.listener.OnLoadCompleteListener;
import com.test.my.app.common.pdfviewer.listener.OnLongPressListener;
import com.test.my.app.common.pdfviewer.listener.OnPageChangeListener;
import com.test.my.app.common.pdfviewer.listener.OnPageErrorListener;
import com.test.my.app.common.pdfviewer.listener.OnPageScrollListener;
import com.test.my.app.common.pdfviewer.listener.OnRenderListener;
import com.test.my.app.common.pdfviewer.listener.OnTapListener;
import com.test.my.app.common.pdfviewer.model.PagePart;
import com.test.my.app.common.pdfviewer.pdfium.PdfDocument;
import com.test.my.app.common.pdfviewer.pdfium.PdfiumCore;
import com.test.my.app.common.pdfviewer.pdfium.util.Size;
import com.test.my.app.common.pdfviewer.pdfium.util.SizeF;
import com.test.my.app.common.pdfviewer.scroll.ScrollHandle;
import com.test.my.app.common.pdfviewer.source.AssetSource;
import com.test.my.app.common.pdfviewer.source.ByteArraySource;
import com.test.my.app.common.pdfviewer.source.DocumentSource;
import com.test.my.app.common.pdfviewer.source.FileSource;
import com.test.my.app.common.pdfviewer.source.InputStreamSource;
import com.test.my.app.common.pdfviewer.source.UriSource;
import com.test.my.app.common.pdfviewer.util.Constants;
import com.test.my.app.common.pdfviewer.util.FitPolicy;
import com.test.my.app.common.pdfviewer.util.MathUtils;
import com.test.my.app.common.pdfviewer.util.SnapEdge;
 ...
 * using {@link # load( Document Source, String, int[])}. In this
...
public class PDFView extends RelativeLayout {
    ...
    private final PaintFlagsDrawFilter antialiasFilter = new PaintFlagsDrawFilter(0, Paint.ANTI_ALIAS_FLAG | Paint.FILTER_BITMAP_FLAG);
    ...
    public void setNightMode(boolean nightMode) {
        ...
        if (nightMode) {
            ColorMatrix colorMatrixInverted = new ColorMatrix(new float[]{-1, 0, 0, 0, 255, 0, -1, 0, 0, 255, 0, 0, -1, 0, 255, 0, 0, 0, 1, 0});
