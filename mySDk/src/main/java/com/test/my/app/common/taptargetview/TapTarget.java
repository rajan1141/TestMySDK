package com.test.my.app.common.taptargetview;
...
public class TapTarget {
    ...
    public TapTarget setConfiguration(Context context) {
        outerCircleColor(R.color.colorPrimary);
        outerCircleAlpha(0.95f);
        targetCircleColor(R.color.white);
        titleTextSize((int) context.getResources().getDimension(R.dimen.tap_view_title));
        descriptionTextSize((int) context.getResources().getDimension(R.dimen.tap_view_desc));
