...
abstract class Gauge constructor(
    ...
    val darkGreen = 0XFF4FA142
    val lightGreen = 0XFFB6D33F
    val yellow = 0XFFFED640
    val orange = 0XFFFFA000
    val red = 0XFFFF181D
    ...
    private var noOfSections = 5
    private var reverseSections = false
    ...
    private fun init() {
        ...
        _sections.add(Section(0f, .2f, darkGreen.toInt(), speedometerWidth).inGauge(this))
        _sections.add(Section(.2f, .4f, lightGreen.toInt(), speedometerWidth).inGauge(this))
        _sections.add(Section(.4f, .6f, yellow.toInt(), speedometerWidth).inGauge(this))
        _sections.add(Section(.6f, .8f, orange.toInt(), speedometerWidth).inGauge(this))
        _sections.add(Section(.8f, 1f, red.toInt(), speedometerWidth).inGauge(this))
    ...
    private fun initAttributeSet(context: Context, attrs: AttributeSet?) {
        ...
        noOfSections = a.getInteger(R.styleable.Gauge_sv_noOfSections, noOfSections)
        reverseSections = a.getBoolean(R.styleable.Gauge_sv_reverseSections, reverseSections)
        setNumberOfSetions(noOfSections,reverseSections)
    ...
    fun setNumberOfSetions(noOfSections:Int,reverseSections:Boolean) {
        Utilities.printLogError("NumberOfSetions--->$noOfSections")
        _sections.clear()
        when(noOfSections) {
            3 -> {
                if (reverseSections) {
                    _sections.add(Section(0f, .33f, red.toInt(), speedometerWidth).inGauge(this))
                    _sections.add(Section(.33f, .66f, yellow.toInt(), speedometerWidth).inGauge(this))
                    _sections.add(Section(.66f, 1f, darkGreen.toInt(), speedometerWidth).inGauge(this))
                } else {
                    _sections.add(Section(0f, .33f, darkGreen.toInt(), speedometerWidth).inGauge(this))
                    _sections.add(Section(.33f, .66f, yellow.toInt(), speedometerWidth).inGauge(this))
                    _sections.add(Section(.66f, 1f, red.toInt(), speedometerWidth).inGauge(this))
                }
            }
            4 -> {
                if (reverseSections) {
                    _sections.add(Section(0f, .25f, red.toInt(), speedometerWidth).inGauge(this))
                    _sections.add(Section(.25f, .50f, yellow.toInt(), speedometerWidth).inGauge(this))
                    _sections.add(Section(.50f, .75f, lightGreen.toInt(), speedometerWidth).inGauge(this))
                    _sections.add(Section(.75f, 1f, darkGreen.toInt(), speedometerWidth).inGauge(this))
                } else {
                    _sections.add(Section(0f, .25f, darkGreen.toInt(), speedometerWidth).inGauge(this))
                    _sections.add(Section(.25f, .50f, lightGreen.toInt(), speedometerWidth).inGauge(this))
                    _sections.add(Section(.50f, .75f, yellow.toInt(), speedometerWidth).inGauge(this))
                    _sections.add(Section(.75f, 1f, red.toInt(), speedometerWidth).inGauge(this))
                }
            }
            else -> {
                if (reverseSections) {
                    _sections.add(Section(0f, .2f, red.toInt(), speedometerWidth).inGauge(this))
                    _sections.add(Section(.2f, .4f, orange.toInt(), speedometerWidth).inGauge(this))
                    _sections.add(Section(.4f, .6f, yellow.toInt(), speedometerWidth).inGauge(this))
                    _sections.add(Section(.6f, .8f, lightGreen.toInt(), speedometerWidth).inGauge(this))
                    _sections.add(Section(.8f, 1f, darkGreen.toInt(), speedometerWidth).inGauge(this))
                } else {
                    _sections.add(Section(0f, .2f, darkGreen.toInt(), speedometerWidth).inGauge(this))
                    _sections.add(Section(.2f, .4f, lightGreen.toInt(), speedometerWidth).inGauge(this))
                    _sections.add(Section(.4f, .6f, yellow.toInt(), speedometerWidth).inGauge(this))
