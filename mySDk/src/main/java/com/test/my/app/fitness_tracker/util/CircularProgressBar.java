    ...
    private void initialize(@NonNull final Context context, @Nullable final AttributeSet attributeSet,
        ...
        if (attributeSet == null) {
            ...
            try {
                ...
                setProgress(attributes.getFloat(R.styleable.CircularProgressBar_progressC, DEFAULT_PROGRESS));
                setStartAngle(attributes.getFloat(R.styleable.CircularProgressBar_startAngleProgress, DEFAULT_START_ANGLE));
