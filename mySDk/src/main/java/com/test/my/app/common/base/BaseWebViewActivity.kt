...
abstract class BaseWebViewActivity : AppCompatActivity() {
    ...
    fun initBase() {
        //Utilities.printLog("onCreate called-----> ")
        ...
        asw_view!!.setDownloadListener(DownloadListener { url, userAgent, contentDisposition, mimeType, contentLength ->
            if (!check_permission(2)) {
                ...
                dm.enqueue(request)
                Utilities.toastMessageLong(this, "Downloading...")
            }
        })
                        ...
                        if (SmartWebViewHelper.ASWP_CAMUPLOAD) {
                            ...
                            if (takePictureIntent.resolveActivity(packageManager) != null) {
                                ...
                                try {
                                    ...
                                    Utilities.printLogError("$TAG---Image file creation failed---${ex}")
                                }
...
//                else
    ...
    private fun showSnackbar(message: String, timeLength: Int) {
        Snackbar.make(this.findViewById<View>(android.R.id.content), message, timeLength).show()
    }
    ...
    fun get_file() {
        ...
        if (SmartWebViewHelper.ASWP_FUPLOAD && SmartWebViewHelper.ASWP_CAMUPLOAD && !check_permission(
            ...
            ActivityCompat.requestPermissions(this, arrayOf(Manifest.permission.CAMERA), file_perm)
        }
    }
    ...
    private inner class CallbackWebViewClient : WebViewClient() {
        ...
        override fun onReceivedError(
            ...
            Utilities.toastMessageShort(applicationContext, getString(R.string.UNEXPECTED_ERROR))
        }
