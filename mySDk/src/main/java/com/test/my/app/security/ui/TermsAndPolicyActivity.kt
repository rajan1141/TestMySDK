...
import com.test.my.app.databinding.ActivityTermsAndPolicyBinding
import com.test.my.app.security.viewmodel.LoginNewViewModel
import dagger.hilt.android.AndroidEntryPoint

@AndroidEntryPoint
class TermsAndPolicyActivity : BaseActivity() {
    ...
    override fun onCreateEvent(savedInstanceState: Bundle?) {
        ...
        data[CleverTapConstants.FROM] = CleverTapConstants.FROM_SIGN_UP
        when (from) {
    ...
    private fun setUpToolbar(title: String) {
        setSupportActionBar(binding.toolBarViewTerms.toolbarTerms)
        binding.toolBarViewTerms.toolbarTitle.text = title
        supportActionBar!!.setDisplayShowTitleEnabled(false)
        supportActionBar!!.setDisplayHomeAsUpEnabled(true)
        supportActionBar!!.setDisplayShowHomeEnabled(true)
        supportActionBar?.setHomeAsUpIndicator(R.drawable.ic_back)
        binding.toolBarViewTerms.toolbarTerms.navigationIcon?.colorFilter =
            BlendModeColorFilterCompat.createBlendModeColorFilterCompat(
                appColorHelper.textColor, BlendModeCompat.SRC_ATOP
            )

        binding.toolBarViewTerms.toolbarTerms.setNavigationOnClickListener {
            onBackPressed()
        }
    }
