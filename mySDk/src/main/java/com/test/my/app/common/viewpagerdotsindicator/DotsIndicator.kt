...
import com.test.my.app.common.viewpagerdotsindicator.BaseDotsIndicator.Type.DEFAULT
    ...
    private fun init(attrs: AttributeSet?) {
        ...
        if (attrs != null) {
            ...
            if (dotsWidthFactor < 1) {
                Utilities.printLogError("DotsIndicator : The dotsWidthFactor can't be set under 1.0f, please set an higher value")
                dotsWidthFactor = 1f
            }
