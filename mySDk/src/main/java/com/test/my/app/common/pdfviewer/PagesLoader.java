...
import static com.test.my.app.common.pdfviewer.util.Constants.Cache.CACHE_SIZE;
import static com.test.my.app.common.pdfviewer.util.Constants.PRELOAD_OFFSET;
