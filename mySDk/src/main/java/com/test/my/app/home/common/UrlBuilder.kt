...
class UrlBuilder(
    ...
    fun buildUrl(): String {
        ...
        val baseUrl = "https://test12-rb2ka4.readyplayer.me/"
        ...
        builder.append("&isCaptureEnabled=true")

        Utilities.printLogError("buildUrl : Url---> $builder")
        return builder.toString()
    }

    private fun appendGender(builder: StringBuilder) {
        if (urlConfig.gender != Gender.NONE) {
            builder.append("&gender=${urlConfig.gender.toString().lowercase()}")
        }
    }
